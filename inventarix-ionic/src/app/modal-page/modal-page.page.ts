...
export class ModalPagePage implements OnInit {
  ...
  constructor(private navParams: NavParams, private modalCtrl: ModalController, public toastController: ToastController, public http: HttpClient, public artPages: ArticlesPage) { }
